...
public class epsnfa{
	...
	int[] union(int s1,int t1,int s2,int t2)
	{
		...
		int newFinalState = incCapacity();
		
		this.addEdge(newStartState, epssymbol, s1);
		this.addEdge(t1, epssymbol, newFinalState);
		this.addEdge(newStartState, epssymbol, s2);
		this.addEdge(t2, epssymbol, newFinalState);
		
		st[0] = newStartState;
		st[1] = newFinalState;
		
		//System.out.println("This is newStartState: " + newStartState + "\n");
	...
	int[] clo(int s,int t)
	{
		...
		this.addEdge(newStartState, epssymbol, s);
		this.addEdge(t, epssymbol, newFinalState);
		this.addEdge(newStartState, epssymbol, newFinalState);
		this.addEdge(t, epssymbol, s);
